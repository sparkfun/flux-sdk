...
// Define our class
class spDevADS122C04 : public flxDeviceI2CType<spDevADS122C04>, public SFE_ADS122C04
{
...
public:
    flxPropertyRWUint8<spDevADS122C04, &spDevADS122C04::get_wire_mode, &spDevADS122C04::set_wire_mode> wireMode
    ...
    flxPropertyRWUint8<spDevADS122C04, &spDevADS122C04::get_sample_rate, &spDevADS122C04::set_sample_rate> sampleRate
    ...
    flxParameterOutFloat<spDevADS122C04, &spDevADS122C04::read_temperature_c> temperatureC;
    flxParameterOutFloat<spDevADS122C04, &spDevADS122C04::read_temperature_f> temperatureF;    
    flxParameterOutFloat<spDevADS122C04, &spDevADS122C04::read_internal_temperature> internalTemperature;    
    flxParameterOutFloat<spDevADS122C04, &spDevADS122C04::read_raw_voltage> rawVoltage;    

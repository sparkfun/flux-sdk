...
class spDevVEML6075 : public flxDeviceI2CType<spDevVEML6075>, public VEML6075
{
...
public:
    ...
    flxPropertyRWUint8<spDevVEML6075, &spDevVEML6075::get_integration_time, &spDevVEML6075::set_integration_time> integrationTime
    ...
    flxPropertyRWUint8<spDevVEML6075, &spDevVEML6075::get_high_dynamic, &spDevVEML6075::set_high_dynamic> highDynamic
        = { VEML6075::DYNAMIC_NORMAL, { { "Normal Dynamic", VEML6075::DYNAMIC_NORMAL }, { "High Dynamic", VEML6075::DYNAMIC_HIGH } } };

    // Define our output parameters - specify the get functions to call.
    flxParameterOutFloat<spDevVEML6075, &spDevVEML6075::read_uva> uva;    
    flxParameterOutFloat<spDevVEML6075, &spDevVEML6075::read_uvb> uvb;    
    flxParameterOutFloat<spDevVEML6075, &spDevVEML6075::read_uv_index> uvIndex;    
};

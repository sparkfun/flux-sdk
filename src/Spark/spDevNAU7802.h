...
private:
    ...
    void calculate_zero_offset(bool dummy);
    void calculate_calibration_factor(float weight_in_units);
...
public:
    ...
    spParameterInUint<spDevNAU7802, &spDevNAU7802::calculate_calibration_factor> calibrationFactor_input;

...
#include "spDevTMP117.h"

// Define our class static variables - allocs storage for them

uint8_t spDevTMP117::defaultDeviceAddress[] = {0x48, 0x49, 0x4A, 0x4B, kSparkDeviceAddressNull};

//----------------------------------------------------------------------------------------------------------
// Register this class with the system, enabling this driver during system
// initialization and device discovery.

spRegisterDevice(spDevTMP117);
...
bool spDevTMP117::isConnected(flxBusI2C &i2cDriver, uint8_t address)
{
...
//
bool spDevTMP117::onInitialize(TwoWire &wirePort)
{
...
double spDevTMP117::read_temperature_C()
{

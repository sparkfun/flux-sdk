...
#include "spDevMS8607.h"

uint8_t spDevMS8607::defaultDeviceAddress[] = {0x76, kSparkDeviceAddressNull};

// Register this class with the system - this enables the *auto load* of this device
spRegisterDevice(spDevMS8607);

spDevMS8607::spDevMS8607()
{
...
float spDevMS8607::read_pressure_mbar()
{
    return MS8607::getPressure();
}
float spDevMS8607::read_temperature_C()
{
    return MS8607::getTemperature();
}
float spDevMS8607::read_humidity()
{
...
bool spDevMS8607::isConnected(spDevI2C &i2cDriver, uint8_t address)
{
...
//
bool spDevMS8607::onInitialize(TwoWire &wirePort)
{

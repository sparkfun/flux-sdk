...
class flxDevKX134 : public flxDeviceI2CType<flxDevKX134>, public SfeKX134ArdI2C
{
  ...
  private:
    ...
    // Internal members
    bool _in_setup; // Used to track if we are in setup mode

...
#include "flxDevSDP3X.h"

// Define our class static variables - allocs storage for them

uint8_t flxDevSDP3X::defaultDeviceAddress[] = {0x21, 0x22, 0x23, kSparkDeviceAddressNull};

//----------------------------------------------------------------------------------------------------------
// Register this class with the system, enabling this driver during system
// initialization and device discovery.

flxRegisterDevice(flxDevSDP3X);
...
bool flxDevSDP3X::isConnected(flxBusI2C &i2cDriver, uint8_t address)
{
...
float flxDevSDP3X::read_temperature_C()
{
...
float flxDevSDP3X::read_pressure()
{
    if (_pressure <= -9998)
    {
        SDP3X::readMeasurement(&_pressure, &_temperature);
...
uint8_t flxDevSDP3X::get_temperature_compensation()
{
    return _tempComp;
}
...
uint8_t flxDevSDP3X::get_measurement_averaging()
{

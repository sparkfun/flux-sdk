...
class flxDevSCD30 : public flxDeviceI2CType<flxDevSCD30>, public SCD30
{
  ...
  public:
    flxPropertyRWUint<flxDevSCD30, &flxDevSCD30::get_measurement_interval, &flxDevSCD30::set_measurement_interval>
        measurementInterval;
    flxPropertyRWUint<flxDevSCD30, &flxDevSCD30::get_altitude_compensation, &flxDevSCD30::set_altitude_compensation>

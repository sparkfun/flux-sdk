...
#include "flxDevSGP30.h"

// Define our class static variables - allocs storage for them

#define kSGP30AddressDefault 0x58 // _SGP30Address is private...

uint8_t flxDevSGP30::defaultDeviceAddress[] = {kSGP30AddressDefault, kSparkDeviceAddressNull};

//----------------------------------------------------------------------------------------------------------
// Register this class with the system, enabling this driver during system
// initialization and device discovery.

flxRegisterDevice(flxDevSGP30);
...
bool flxDevSGP30::isConnected(flxBusI2C &i2cDriver, uint8_t address)
{
...
//
bool flxDevSGP30::onInitialize(TwoWire &wirePort)
{

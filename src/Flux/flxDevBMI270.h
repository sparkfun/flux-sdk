...
class flxDevBMI270 : public flxDeviceI2CType<flxDevBMI270>, public BMI270
{
    ...
    public:
        ...
        flxPropertyRWUint8<flxDevBMI270, &flxDevBMI270::get_accel_odr, &flxDevBMI270::set_gyro_odr>
            accelDataRate = {BMI2_ACC_ODR_100HZ,
        ...
        flxPropertyRWUint8<flxDevBMI270, &flxDevBMI270::get_accel_power_mode, &flxDevBMI270::set_accel_power_mode>
            accelPowerMode = {BMI2_PERF_OPT_MODE,
                              {{"Performance Mode", BMI2_PERF_OPT_MODE},
                               {"Power Saving Mode", BMI2_POWER_OPT_MODE}}};
        ...
        flxPropertyRWUint8<flxDevBMI270, &flxDevBMI270::get_accel_filter_bandwidth, &flxDevBMI270::set_accel_filter_bandwidth>
        ...
        flxPropertyRWUint8<flxDevBMI270, &flxDevBMI270::get_gyro_odr, &flxDevBMI270::set_gyro_odr>
            gyroDataRate = {BMI2_GYR_ODR_200HZ,
        ...
        // Default Value is BMI2_PERF_OPT_MODE
        flxPropertyRWUint8<flxDevBMI270, &flxDevBMI270::get_gyro_power_mode_filter, &flxDevBMI270::set_gyro_power_mode_filter>

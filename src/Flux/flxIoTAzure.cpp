...
static void hmac_sha256_sign_signature(az_span decoded_key, az_span signature, az_span signed_signature,
...
static int iot_sample_generate_sas_base64_encoded_signed_signature(az_span sas_base64_encoded_key,
                                                                   ...
                                                                   az_span *out_sas_base64_encoded_signed_signature)
{
    ...
    hmac_sha256_sign_signature(sas_decoded_key, sas_signature, sas_hmac256_signed_signature,
                               &sas_hmac256_signed_signature);

    // Base64 encode the result of the HMAC signing.
    base64_encode_bytes(sas_hmac256_signed_signature, sas_base64_encoded_signed_signature,
...
az_span generate_sas_token(az_iot_hub_client *hub_client, az_span device_key, az_span sas_signature,
                           unsigned int expiryTimeInMinutes, az_span sas_token)
{
    az_result rc;
...
AzIoTSasToken::AzIoTSasToken(az_iot_hub_client *client, az_span deviceKey, az_span signatureBuffer,
...
// SparkFun - Added this method to enable post creation init of the object.
void AzIoTSasToken::initialize(az_iot_hub_client *client, az_span deviceKey, az_span signatureBuffer,
                               az_span sasTokenBuffer)
{
    this->client = client;
    this->deviceKey = deviceKey;
...
{
    this->sasToken = generate_sas_token(this->client, this->deviceKey, this->signatureBuffer, expiryTimeInMinutes,
                                        this->sasTokenBuffer);

...
#include "flxDevMS5637.h"

uint8_t flxDevMS5637::defaultDeviceAddress[] = {MS5637_ADDR, kSparkDeviceAddressNull};

// Register this class with the system - this enables the *auto load* of this device
flxRegisterDevice(flxDevMS5637);

flxDevMS5637::flxDevMS5637()
{
...
float flxDevMS5637::read_pressure_mbar()
{
    return MS5637::getPressure();
}
float flxDevMS5637::read_temperature_C()
{
...
bool flxDevMS5637::isConnected(flxBusI2C &i2cDriver, uint8_t address)
{
...
//
bool flxDevMS5637::onInitialize(TwoWire &wirePort)
{

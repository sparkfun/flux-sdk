  ...
  public:
    test_properties()
    {
        ...
        prop_uint_range.addDataLimitValidValue(
            {{"Value One", 22}, {"Value Two", 44}, {"Value Three", 66}, {"Value Four", 88}, {"Value Five", 110}});
    ...
    flxPropertyUint8<test_properties> prop_int = {
        {"Value One", 10}, {"Value Two", 22}, {"Value Three", 33}, {"Value Four", 44}, {"Value Five", 155}};
    // Test property with an initial value and a value limit set.
    flxPropertyUint8<test_properties> prop_int_set = {
        44, {{"Value 1One", 10}, {"Value 1Two", 22}, {"Value 1Three", 33}, {"Value 1Four", 44}, {"Value 1Five", 155}}};
    ...
    flxPropertyRWInt<test_properties, &test_properties::get_int, &test_properties::set_int> rw_prop_int = {
        111, {{"Value One", 111}, {"Value Two", 222}, {"Value Three", 333}, {"Value Four", 444}, {"Value Five", 555}}};

...
void run_tests()
{
    ...
    Serial.print(myTest.in_bool.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.in_bool.description());
    Serial.print("Output NAME: ");
    Serial.print(myTest.out_bool.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.out_bool.description());

    myTest.in_bool(b_test);
    Serial.print("   Test 1: ");
    Serial.println((myTest.out_bool() == b_test ? "PASS" : "FAIL"));

    b_test = true;
    myTest.in_bool.set(b_test);
    Serial.print("   Test 2: ");
    Serial.println((myTest.out_bool.get() == b_test ? "PASS" : "FAIL"));

    //---------------------------------------------------------------------------------------------------
    Serial.println();
    Serial.println("Int8 Tests:");
    Serial.print("Input NAME: ");
    Serial.print(myTest.in_int8.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.in_int8.description());
    Serial.print("Output NAME: ");
    Serial.print(myTest.out_int8.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.out_int8.description());

    int8_t i8_test = -23;

    myTest.in_int8(i8_test);
    Serial.print("   Test 1: ");
    Serial.println((myTest.out_int8() == i8_test ? "PASS" : "FAIL"));

    i8_test += 25;
    myTest.in_int8.set(i8_test);
    Serial.print("   Test 2: ");
    Serial.println((myTest.out_int8.get() == i8_test ? "PASS" : "FAIL"));

    //---------------------------------------------------------------------------------------------------
    Serial.println();
    Serial.println("Int16 Tests:");
    Serial.print("Input NAME: ");
    Serial.print(myTest.in_int16.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.in_int16.description());
    Serial.print("Output NAME: ");
    Serial.print(myTest.out_int16.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.out_int16.description());

    int16_t i16_test = -13;

    myTest.in_int16(i16_test);
    Serial.print("   Test 1: ");
    Serial.println((myTest.out_int16() == i16_test ? "PASS" : "FAIL"));

    i16_test += 5;
    myTest.in_int16.set(i16_test);
    Serial.print("   Test 2: ");
    Serial.println((myTest.out_int16.get() == i16_test ? "PASS" : "FAIL"));

    //---------------------------------------------------------------------------------------------------
    Serial.println();
    Serial.println("Int Tests:");
    Serial.print("Input NAME: ");
    Serial.print(myTest.in_int.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.in_int.description());
    Serial.print("Output NAME: ");
    Serial.print(myTest.out_int.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.out_int.description());

    int i_test = 3;

    myTest.in_int(i_test);
    Serial.print("   Test 1: ");
    Serial.println((myTest.out_int() == i_test ? "PASS" : "FAIL"));

    i_test += 5;
    myTest.in_int.set(i_test);
    Serial.print("   Test 2: ");
    Serial.println((myTest.out_int.get() == i_test ? "PASS" : "FAIL"));

    //---------------------------------------------------------------------------------------------------
    Serial.println();
    Serial.println("UInt8 Tests:");
    Serial.print("Input NAME: ");
    Serial.print(myTest.in_uint8.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.in_uint8.description());
    Serial.print("Output NAME: ");
    Serial.print(myTest.out_uint8.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.out_uint8.description());

    uint8_t ui8_test = 43;

    myTest.in_uint8(ui8_test);
    Serial.print("   Test 1: ");
    Serial.println((myTest.out_uint8() == ui8_test ? "PASS" : "FAIL"));

    ui8_test += 26;
    myTest.in_uint8.set(ui8_test);
    Serial.print("   Test 2: ");
    Serial.println((myTest.out_uint8.get() == ui8_test ? "PASS" : "FAIL"));

    //---------------------------------------------------------------------------------------------------
    Serial.println();
    Serial.println("UInt16 Tests:");
    Serial.print("Input NAME: ");
    Serial.print(myTest.in_uint16.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.in_uint16.description());
    Serial.print("Output NAME: ");
    Serial.print(myTest.out_uint16.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.out_uint16.description());

    uint16_t ui16_test = -13;

    myTest.in_uint16(ui16_test);
    Serial.print("   Test 1: ");
    Serial.println((myTest.out_uint16() == ui16_test ? "PASS" : "FAIL"));

    ui16_test += 56;
    myTest.in_uint16.set(ui16_test);
    Serial.print("   Test 2: ");
    Serial.println((myTest.out_uint16.get() == ui16_test ? "PASS" : "FAIL"));

    //---------------------------------------------------------------------------------------------------
    Serial.println();
    Serial.println("Float Tests:");
    Serial.print("Input NAME: ");
    Serial.print(myTest.in_float.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.in_float.description());
    Serial.print("Output NAME: ");
    Serial.print(myTest.out_float.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.out_float.description());

    float f_test = 3.134;

    myTest.in_float(f_test);
    Serial.print("   Test 1: ");
    Serial.println((myTest.out_float() == f_test ? "PASS" : "FAIL"));
    f_test += 5.;
    myTest.in_float.set(f_test);
    Serial.print("   Test 2: ");
    Serial.println((myTest.out_float.get() == f_test ? "PASS" : "FAIL"));

    //---------------------------------------------------------------------------------------------------
    Serial.println();
    Serial.println("String Tests:");
    Serial.print("Input NAME: ");
    Serial.print(myTest.in_string.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.in_string.description());
    Serial.print("Output NAME: ");
    Serial.print(myTest.out_string.name());
    Serial.print("  DESC: ");
    Serial.println(myTest.out_string.description());

    std::string s_test = "COW";

    myTest.in_string(s_test);
    Serial.print("   Test 1: ");
    Serial.println((myTest.out_string() == s_test ? "PASS" : "FAIL"));
    s_test += "goes moo";
    myTest.in_string.set(s_test);
    Serial.print("   Test 2: ");
    Serial.println((myTest.out_string.get() == s_test ? "PASS" : "FAIL"));
